...
THREE.OrbitControls = function ( object, domElement ) {
	...
	this.update = function () {
		...
		// console.log(555,this.autoRotate,state === STATE.NONE);
	...
	function onMouseDown( event ) {
		...
		// в общем тут можно разбираться, идеи есть  http://stackoverflow.com/questions/12886286/addeventlistener-for-keydown-on-canvas
