SceneObject {
  ...
  function makeCones( radius, nx, positions, colors ) {
    var circle = [];
  ...
  function make() {
    var res = makeCones( radius, nx, positions, colors && colors.length > 0 ? colors : null );
